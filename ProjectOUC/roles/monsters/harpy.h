...
{
public:
    Harpy(int _level = 0, Attr _attr = Attr(), std::string _name = "Harpy", int _coin = 0, Position _pos = Position(), bool _moved = false) :
        Monster(_level, _attr, _name, _coin, _pos, _moved,HARPY)
    {
		Attr attr;
